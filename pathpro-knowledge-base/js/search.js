...
(function () {
  ...
  var SEARCH_INDEX = [
    ...
    { title: 'Roadmap & Task Management', url: '/articles/core-features/roadmap-and-tasks.html', category: 'Core Features', excerpt: 'Task groups, tasks, subtasks, statuses, assignments, drag-and-drop.', headings: ['Task Groups', 'Creating Tasks', 'Task Statuses & Types', 'Subtasks', 'Assignments', 'File Attachments', 'Focus Mode', 'Public vs Internal Roadmap', 'PathFox: Your New Team Member'] },
    ...
    { title: 'Publishing Overview', url: '/articles/publishing-projects/overview.html', category: 'Publishing Projects', excerpt: 'How to publish your project — direct links, embeds, widgets, and custom domains.', headings: ['Your Project URL', 'Embedding Options', 'Widgets', 'Custom Domains'] },
    { title: 'Widgets', url: '/articles/publishing-projects/widgets.html', category: 'Publishing Projects', excerpt: 'Embeddable widgets for feature voting, roadmap, release notes, support, and full project.', headings: ['Full Project Widget', 'Feature Voting Widget', 'Roadmap Widget', 'Release Notes Widget', 'Support Widget'] },
